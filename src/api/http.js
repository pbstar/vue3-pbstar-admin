...
if (!baseURL) {
  if (units.isDomain(location.hostname) && location.hostname != 'localhost') baseURL = location.protocol + '//' + location.hostname + '/api';
  else baseURL = location.protocol + '//' + location.hostname + ':8091/api';
}
